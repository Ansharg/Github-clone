    ...
    <div className='grid grid-cols-3 gap-4 bg-transparent'>
        <div className='py-5 bg-transparent border border-gray-500 rounded-md cursor-pointer'>
            ...
            <div className=' w-28 bg-transparent'>
                <p className='text-center bg-transparent text-gray-500'>Samuel</p>
            </div>
            <div className='w-28 bg-transparent'>
                <button className='w-full border border-gray-500 rounded-md flex items-center justify-center bg-transparent space-x-2 text-gray-300 '>
                    <AiOutlineHeart className='text-white text-lg bg-transparent' /><span className=' bg-transparent'>Sponsor</span>
                </button>
            </div>
            </div>
        </div>
        <div className='py-5 bg-transparent border border-gray-500 rounded-md  cursor-pointer'>
            ...
            <div className=' w-28 bg-transparent'>
                <p className='text-center bg-transparent text-gray-500'>Nick DeJesus</p>
            </div>
            <div className='w-28 bg-transparent'>
                <button className='w-full border border-gray-500 rounded-md flex items-center justify-center text-gray-300 bg-transparent space-x-2'>
                    <AiOutlineHeart className='text-white text-lg bg-transparent' /><span className=' bg-transparent'>Sponsor</span>
                </button>
            </div>
            </div>
        ...
        <div className='py-5 bg-transparent border border-gray-500 rounded-md cursor-pointer'>
            ...
            <div className='w-28 bg-transparent'>
                <button className='w-full border rounded-md border-gray-500 flex items-center justify-center text-gray-300 bg-transparent space-x-2'>
                    <AiOutlineHeart className='text-white text-lg bg-transparent' /><span className=' bg-transparent'>Sponsor</span>
                </button>
            </div>
            </div>
        ...
        <div className='py-5 bg-transparent border border-gray-500 rounded-md cursor-pointer'>
            ...
            <div className=' w-28 bg-transparent'>
                <p className='text-center bg-transparent text-gray-500'>Directus</p>
            </div>
            <div className='w-28 bg-transparent'>
                <button className='w-full border rounded-md border-gray-500 flex items-center justify-center text-gray-300 bg-transparent space-x-2'>
                    <AiOutlineHeart className='text-white text-lg bg-transparent' /><span className=' bg-transparent'>Sponsor</span>
        ...
        <div className='py-5 bg-transparent border border-gray-500 rounded-md cursor-pointer'>
            ...
            <div className=' w-28 bg-transparent'>
                <p className='text-center bg-transparent text-gray-500'>Nikema</p>
            </div>
            <div className='w-28 bg-transparent'>
                <button className='w-full border rounded-md border-gray-500 flex items-center justify-center text-gray-300 bg-transparent space-x-2'>
                    <AiOutlineHeart className='text-white text-lg bg-transparent' /><span className=' bg-transparent'>Sponsor</span>
        ...
        <div className='py-5 bg-transparent border border-gray-500 rounded-md cursor-pointer'>
            ...
            <div className=' w-28 bg-transparent'>
                <p className='text-center bg-transparent text-gray-500'>Evan You</p>
            </div>
            <div className='w-28 bg-transparent'>
                <button className='w-full border rounded-md border-gray-500 flex items-center justify-center text-gray-300 bg-transparent space-x-2'>
                    <AiOutlineHeart className='text-white text-lg bg-transparent' /><span className=' bg-transparent'>Sponsor</span>
        ...
        <div className='py-5 bg-transparent border border-gray-500 rounded-md cursor-pointer'>
            ...
            <div className='w-28 bg-transparent'>
                <button className='w-full flex rounded-md border border-gray-500 items-center justify-center text-gray-300 bg-transparent space-x-2'>
                    <AiOutlineHeart className='text-white text-lg bg-transparent' /><span className=' bg-transparent'>Sponsor</span>
                </button>
            </div>
            </div>
        ...
        <div className='py-5 bg-transparent border border-gray-500 rounded-md cursor-pointer'>
            ...
            <div className='w-28 bg-transparent'>
                <button className='w-full flex rounded-md items-center justify-center border border-gray-500 text-gray-300 bg-transparent space-x-2'>
                    <AiOutlineHeart className='text-white text-lg bg-transparent' /><span className=' bg-transparent'>Sponsor</span>
                </button>
            </div>
            </div>
